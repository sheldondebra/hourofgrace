...
<div class="stat-grid">
  <a href="submissions.php?filter=contact" class="stat-card">
  ...
  <a href="submissions.php?filter=prayer" class="stat-card">
  ...
  <a href="submissions.php?filter=register" class="stat-card">
  ...
  <a href="submissions.php?filter=school" class="stat-card">
  ...
  <a href="hero.php" class="stat-card">
  ...
  <a href="giving.php" class="stat-card">
